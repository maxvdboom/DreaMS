...
Usage: python test_bce_quick_simple.py --loss bce_logits --samples 100 --epochs 1
"""
...
def main():
    ...
    if result.returncode == 0:
        ...
        print("     python test_bce_quick_simple.py --loss cos")
        print("     python test_bce_quick_simple.py --loss bce_logits --samples 500 --epochs 2")
        print()
