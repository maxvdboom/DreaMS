#!/bin/bash
#SBATCH --job-name=DreaMS_fine-tuning_bce
...
SCRATCH_DIR="/scratch-shared/$USER/dreams_finetune_bce_$$"
...
# Configuration
PROJECT_NAME="MassSpecGym_Morgan2048_BCE"
RUN_NAME="massspecgym_morgan2048_finetune_bce_$(date +%Y%m%d_%H%M%S)"
...
WANDB_PROJECT="MorganFingerprints"

# Optional positive-class weighting for sparse fingerprints.
# Example for ~2.2% positives: export FP_POS_WEIGHT=44
FP_POS_WEIGHT=${FP_POS_WEIGHT:-}
FP_POS_WEIGHT_ARGS=""
if [ -n "$FP_POS_WEIGHT" ]; then
    FP_POS_WEIGHT_ARGS="--fp_pos_weight $FP_POS_WEIGHT"
    echo "Using BCE pos_weight: $FP_POS_WEIGHT"
fi
...
echo "=================================="
echo "MassSpecGym Fine-Tuning (BCE logits)"
echo "=================================="
echo "Project: $PROJECT_NAME"
echo "Run: $RUN_NAME"
echo "Dataset: $DATASET_PATH"
echo "Objective: Morgan Fingerprints (2048-bit)"
echo "Loss: BCEWithLogitsLoss"
